...
export function toSSE(chunkIter) {
...
function toLine(chunkIter) {
    return __asyncGenerator(this, arguments, function* toLine_1() {
        ...
        try {
            for (var _d = true, chunkIter_1 = __asyncValues(chunkIter), chunkIter_1_1; chunkIter_1_1 = yield __await(chunkIter_1.next()), _a = chunkIter_1_1.done, !_a;) {
...
function toMessage(lineIter) {
    return __asyncGenerator(this, arguments, function* toMessage_1() {
        ...
        try {
            for (var _d = true, lineIter_1 = __asyncValues(lineIter), lineIter_1_1; lineIter_1_1 = yield __await(lineIter_1.next()), _a = lineIter_1_1.done, !_a;) {
